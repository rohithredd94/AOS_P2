...
//State message is sent over converge cast tree , state message should have the process state and all its incoming channel states 
@SuppressWarnings("serial")
...
//Finish message is sent by Node 0 to all the other nodes in the system to bring the entire system to halt and write to output console
@SuppressWarnings("serial")
